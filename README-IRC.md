...
current list can be seen by running:
    ...
    electrum-lanacoin-server peers
...
`electrum-lanacoin-server peers` will always return an empty list.
...
composing the IRC nickname to identify your server on #electrum-lanacoin.
